...
namespace BestFood.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
       ...
       // }
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,Nome,Sobrenome,Enderco1,Enderco2,Cep,Estado,Cidade,Telefone,Email,PedidoEnviado,PedidoEntregueEm")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PedidoId,Nome,Sobrenome,Enderco1,Enderco2,Cep,Estado,Cidade,Telefone,Email,PedidoEnviado,PedidoEntregueEm")] Pedido pedido)
        {
