...
namespace BestFood.Models
{
    ...
    public class Lanche
    {
        ...
        [Required(ErrorMessage = "A descrição do lanche deve ser iformada")]
        [Display(Name = "Descrição do Lanche")]
        [MinLength(20, ErrorMessage = "A descrição deve ter nomínimo {1} caracteres")]
        ...
        [Display(Name = "Caminho Imagem Nomal")]
